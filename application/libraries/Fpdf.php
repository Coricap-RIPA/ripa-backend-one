...
class FPDF {
	...
	*******************************************************************************/
	...
	function Footer()
	{
		...
		// Page number
		//$this->Cell(0,1,'PAGE '.$this->PageNo().' COPYRIGHT CADEAUMART '.date('Y'),0,0,'C');
	}
...
class PDF extends FPDF
{
    ...
    function __construct($orientation='P',$unit='mm',$format='A4',$_title=null,$_url=null,$_debug=false)
    {
        parent::__construct($orientation,$unit,$format);
        $this->B=0;
        $this->I=0;
