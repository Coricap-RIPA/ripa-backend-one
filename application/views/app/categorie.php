				...
				<div class=" container">
					...
					<div class="row">
						<a class="menu-vertical hidden-md hidden-lg blue">
							<span class="animate-default"><i class="fa fa-<?php if(!empty($categorie)) echo $categorie['icon_categorie'];?>" aria-hidden="true"></i><?php if(!empty($categorie)) echo $categorie['nom_categorie'];?></span>
						...
						<div class="breadcrumb-web">
							...
							<?php 
								if( !empty($sous_categories) ){
									foreach ($sous_categories as $key => $sous_categorie_in) {
										if (!empty($sous_categorie_in) ) {
											echo '<a href="'.site_url('AppCategorie/filter/').$categorie['id_categorie'].'/'.$sous_categorie_in['id_sous_categorie'].'"><span class="badge badge-success">'.$sous_categorie_in['nom_sous_categorie'].'</span></a>';
							...
							<ul class="clear-margin">
								<?php 
									if (!empty($sous_categorie) ) {
										echo '<a href="'.site_url('AppCategorie/filter/').$categorie['id_categorie'].'/'.$sous_categorie['id_sous_categorie'].'"><span class="badge badge-primary">'.$sous_categorie['nom_sous_categorie'].'</span></a>';
									}
		...
		<!-- <div class="col-md-4 col-sm-4 col-xs-12 product-category relative effect-hover-boxshadow animate-default">
					...
					<center>
						<h3 class="title-product clearfix full-width title-hover-black">
							<a href="'.site_url('AppArticle/index/').$article['id_article'].'" style="color: #000;  text-shadow: 2px 2px 3px #fff;">'.$article['nom_article'].'</a>
						</h3>
						<p class="clearfix price-product">
