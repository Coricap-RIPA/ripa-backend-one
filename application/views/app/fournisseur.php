				...
				<div class=" container">
					<div class="row">
						<div class=" header-top">
							...
							<div class="clear-padding menu-header-top text-right col-md-8 col-xs-12 col-sm-6"></div>
						</div>
					</div>
					<div class="row">
					...
					<div class="row">
						<a class="menu-vertical hidden-md hidden-lg blue">
							<span class="animate-default"><i class="fa fa-<?php if(!empty($fournisseurs)) echo $fournisseurs['icon_categorie'];?>" aria-hidden="true"></i><?php if(!empty($fournisseurs)) echo $fournisseurs['nom_categorie'];?></span>
							...
							<div class="bar-category bottom-margin-default border no-border-r no-border-l no-border-t">
								<div class="row">
									<div class="col-md-5 col-sm-5 col-xs-8 right-category-bar float-right relative">
										...
										<p class=" float-left"><b>Total de <?php if($fournisseurs) echo count($fournisseurs)-3; ?> </b></p>
									</div>
								</div>
							</div>
									...
									if($fournisseurs){
										foreach ($fournisseurs as $key => $fournisseur) {
											...
											echo ' <div class="col-6"> 
														<div class="col-12"> 
															<a href="'.site_url('AppFournisseur/filter/').$fournisseur['id_fournisseur'].'/">
																<img src = "'.base_url('assets/uploads/files/').$fournisseur['logo_fournisseur'].'" alt="'.$fournisseur['nom_fournisseur'].'" style="width:100%; height: 180px; object-fit:cover;" />
															</a>
														</div>
														<div class="col-12"> 
															<center>
																<h3 class="title-product clearfix full-width title-hover-black"><a href="'.site_url('AppFournisseur/filter/').$fournisseur['id_fournisseur'].'/'.$fournisseurs['id_categorie'].'" style="color: #000;  text-shadow: 2px 2px 3px #fff;">'.$fournisseur['nom_fournisseur'].'</a></h3>
															</center>
														</div>
													</div>';
										}
