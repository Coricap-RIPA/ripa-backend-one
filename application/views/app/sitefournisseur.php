<?php 
	...
	$index_fournisseurs = count($fournisseurs) - 4;
	$index_fournisseurs = mt_rand(0, $index_fournisseurs);
?>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="menu-header full-width">
                            <ul class="clear-margin">
                                <li><a class="animate-default" href="#"><i class="fa fa-list" aria-hidden="true"></i> <?php echo strtoupper( $fournisseurs['nom_categorie'] ); ?> </a></li>
                            </ul>
                        </div>
                        <!-- End Menu Page -->
                    </div>
				...
				<div class="row">
					<div class="breadcrumb-web">
						<ul class="clear-margin">
							...
							<li class="animate-default title-hover-red"><a><?php echo $fournisseurs['nom_categorie']; ?></a></li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="row ">
					...
					<div class="col-md-9 relative clear-padding">
						<div class="banner-top-category-page bottom-margin-default effect-bubba zoom-image-hover overfollow-hidden relative full-width">
							<img src="<?php echo base_url('assets/uploads/files/'.$fournisseurs[$index_fournisseurs]['logo_fournisseur']); ?>" alt="" style="width:875px; height:385px; object-fit: cover;"/>
							<a href="#"></a>
						</div>
						<div class="bar-category bottom-margin-default border no-border-r no-border-l no-border-t">
							<div class="row">
								<div class="col-md-5 col-sm-5 col-xs-4">
									<p class="title-category-page clear-margin"><?php echo $fournisseurs['nom_categorie']; ?></p>
								</div>
							</div>
						</div>
							...
							<?php 
								if( !empty($fournisseurs) ){
									foreach ($fournisseurs as $key => $fournisseur) {
										if( is_int($key)){
											echo '<div class="col-md-4 col-sm-4 col-xs-12 product-category relative effect-hover-boxshadow animate-default">
													<div class="image-product relative overfollow-hidden">
														<div class="center-vertical-image">
															<img src="'.base_url('assets/uploads/files/'.$fournisseur['logo_fournisseur']).'" alt="Product" style="width:270px; height:270px; object-fit:cover;">
														</div>
														<a href="'.site_url('AppFournisseur/sitefilter/').$fournisseur['id_fournisseur'].'/"></a>
													</div>
													<h3 class="title-product clearfix full-width title-hover-black"><a href="'.site_url('AppFournisseur/sitefilter/').$fournisseur['id_fournisseur'].'">'.$fournisseur['nom_fournisseur'].'</a></h3>
												</div>';
										}
									}
								}
