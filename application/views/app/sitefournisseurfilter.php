                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="menu-header full-width">
                            <ul class="clear-margin">
                                <li><a class="animate-default" href="#"><i class="fa fa-list" aria-hidden="true"></i> <?php echo strtoupper( $fournisseur['nom_fournisseur'] ); ?> </a></li>
                            </ul>
                        </div>
                        <!-- End Menu Page -->
                    </div>
				...
				<div class="row">
					<div class="breadcrumb-web">
						<ul class="clear-margin">
							...
							<li class="animate-default title-hover-red"><a><?php echo $fournisseur['nom_fournisseur'] ; ?></a></li>
						</ul>
					</div>
				</div>
			</div>
						...
						<div class="bar-category bottom-margin-default border no-border-r no-border-l no-border-t">
							<div class="row">
								<div class="col-md-5 col-sm-5 col-xs-4">
									<p class="title-category-page clear-margin"><?php echo $fournisseur['nom_fournisseur'] ; ?></p>
								</div>
							</div>
						</div>
