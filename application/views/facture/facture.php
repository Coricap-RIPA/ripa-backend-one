...
<body style="background-color: whitesmoke;">
    ...
    <div class="main_container">
        ...
        <div id="row_content" class="row">
            ...
            <form action="<?php echo site_url('Facture/index/');?>" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col s3">
                        <div class="form-group">
                            ...
                            <a href="<?php echo site_url('Facture/index/'); ?>" class="btn btn-success col s12">Effacer le filtre</a>
                        </div>
                    </div>
    ...
    <script>
        $(function(){
            $("#qr_code_facture_field_box").hide();
        });
    </script>
