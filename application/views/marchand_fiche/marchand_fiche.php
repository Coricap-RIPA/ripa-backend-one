    ...
    <div class="main_container">
        ...
        <div id="row_content" class="row">
            ...
            <div class="row col s12">
                <fieldset>
                    <legend>
                        LISTE DES FICHES DES MARCHANDS
                    </legend>
                </fieldset>
            </div>
            ...
            <div class="col s12">
                ...
                <form action="<?php echo site_url('Entreprise/index/');?>" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col s3">
                            <div class="form-group">
                                ...
                                <a href="<?php echo site_url('Entreprise/index/'); ?>" class="btn btn-success col s12">Effacer le filtre</a>
                            </div>
                        </div>
