...
<body>
    ...
    <p>
        Fromatter built the Fromater app as
        a Free app. This SERVICE is provided by
        Fromatter at no cost and is intended for use as
        is.
    </p>
    <p>
    ...
    <p>
        ...
        Fromater unless otherwise defined in this Privacy Policy.
    </p>
    <p><strong>Information Collection and Use</strong></p>
    <p>
        For a better experience, while using our Service, we
        may require you to provide us with certain personally
        identifiable information, including but not limited to name, post name, first name, phone number, Residence address. The information that
    ...
    <p>
        ...
        Privacy Policy, do not hesitate to contact us at pascalmmp@gmail.com.
    </p>
