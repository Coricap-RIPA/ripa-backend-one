			...
			<div class="row">
				...
				<div class="col-xxl-6 col-xl-6 col-lg-6 end-side-content">
					<div class="login-area">
						<h2 class="text-secondary text-center">Content de vous revoir</h2>
						<p class="text-center m-b25">Bienvenue veuillez vous connecter à votre compte</p>
						<form action="<?php echo site_url('AppCouple/process_login/'); ?>" method="POST">
							<div class="m-b30">
								<label class="label-title">Tél couple</label>
								<input name="tel_whatsapp_couple" required="" class="form-control" placeholder="Ex : +243971101045" type="tel">
								<span><i>Mettez le même numéro, au même format avec lequel vous vous êtes inscrit !</i></span>
							</div>
							<div class="m-b15">
								<label class="label-title">Mot de Passe</label>
								<input name="mot_de_passe_couple" required="" class="form-control" placeholder="Mot de passe" type="password">
							</div>
							<div class="form-row d-flex justify-content-between m-b30" style="display:none !important;">
								<div class="form-group">
								   <div class="custom-control custom-checkbox">
										<input type="checkbox" class="form-check-input" id="basic_checkbox_1" name="remember_me">
										<label class="form-check-label" for="basic_checkbox_1">se souvenir de moi</label>
									</div>
								</div>
								<div class="form-group">
									<a class="text-primary" href="javascript:void(0);">Mot de passe oublié ?</a>
								</div>
							</div>
							<br>
							<div class="text-center">
								<button type="submit" class="btn btn-secondary btnhover text-uppercase me-2">Connexion</button>
								<a href="<?php echo site_url('AppCouple/register/');?>" class="btn btn-outline-secondary btnhover text-uppercase">S'enregistrer</a>
							</div>
						</form>
					</div>
				</div>
