...
<div class="page-wraper">
	...
	<div class="page-content">
		<!--banner-->
		<div class="dz-bnr-inr style-1" style="background-image:url(<?php echo base_url('assets/site_app_assets/images/'); ?>background/bg-shape.jpg);">
			<div class="container">
				<div class="dz-bnr-inr-entry">
					<h1>Cadeaux Categorie <?php echo $categorie_article['nom_categorie']; ?></h1>
					<nav aria-label="breadcrumb" class="breadcrumb-row">
						<ul class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo site_url('AppIndex/sinteindex/'); ?>"> Accueille</a></li>
							<li class="breadcrumb-item"> <?php echo $categorie_article['nom_categorie']; ?> </li>
						</ul>
					</nav>
				</div>
			</div>
													...
													echo '  <div class="article_container col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30" idDatabase="'.($key+1).'">
																<div class="shop-card">
																	...
																	<div class="product-tag">
																		...
																		<span class="badge badge-primary" style="background-color: #f31173; font-size: 10px;">'.$categorie_article['nom_categorie'].'</span>
																	</div>
																</div>	
															</div>';
												}
...
<script>
	$(function(){
		...
		var id_categorie = "<?php echo $categorie_article['id_categorie']; ?>";

		$("body").find('.'+id_categorie+'_categorie').addClass('categorie_link_active');
		...
		$("#id-button-load-more").click(function (e) { 
			...
			$.ajax({
				type: "get",
				url: "<?php echo site_url('AppCategorie/loadMoreArticles/'); ?>",
				data: {'index_limit_bdd':last_index_date_base,'id_categorie': id_categorie},
