		...
		<section class="content-inner shop-account">
			...
			<div class="container">
				<div class="row">
									...
									<div class="form-group">
										<div class="input-group mb-0">
											<a href="https://wa.me/243810274370?text=Bonjour cadeauMart" class="btn btn-secondary btn-icon" style="background-color:#0d775e !important; border-color:#0d775e !important; ">
												...
												<span class="d-md-block d-none">JE GERE MA LISTE AVEC CADEAU MART</span>
											</a> 
										</div>
									</div>
								</div>
					...
					<div class="col-lg-4">
						<h4 class="title mb15"> Total Liste des cadeaux </h4>
						<div class="cart-detail">
							...
							<a href="https://wa.me/" class="btn btn-secondary btn-icon">
								<i class="fab fa-whatsapp"></i>
								<span class="d-md-block d-none">JE COMMUNIQUE MON CODE </span>
							</a>
						</div>
					</div>
				</div>
