		...
		<section class="content-inner shop-account">
			...
			<div class="container">
				<div class="row">
									...
									<div class="form-group">
										<div class="input-group mb-0">
											<a href="https://wa.me/243810274370?text=Bonjour cadeauMart" class="btn btn-secondary btn-icon" style="background-color:#0d775e !important; border-color:#0d775e !important; ">
												...
												<span class="d-md-block d-none">JE ME RENSEIGNE SUR WHATSAPP</span>
											</a> 
										</div>
									</div>
								</div>
					...
					<div class="col-lg-4">
						<h4 class="title mb15"> Total Du Panier </h4>
							...
							<table>
								<tbody>
									<tr class="total">
										...
										<td class="price" id="id_sous_total_panier_main">
											<?php echo number_format($sous_total_panier, 0, ',',' ').' $'?>
										</td>
									</tr>
								</tbody>
							</table>
							<a href="<?php echo site_url('AppCheckOut/index/'); ?>" class="btn btn-secondary w-100">JE PASSE A L'ACHAT</a>
						</div>
					</div>
				</div>
			</div>
