		...
		<div class="dz-bnr-inr style-1" style="background-image:url(<?php echo base_url('assets/site_app_assets/images/'); ?>background/bg-shape.jpg);">
			<div class="container">
				<div class="dz-bnr-inr-entry">
					<h1>Cadeaux Section <?php echo $section['nom_section_article']; ?></h1>
					<nav aria-label="breadcrumb" class="breadcrumb-row">
						<ul class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo site_url('AppIndex/sinteindex/'); ?>"> Accueille</a></li>
							<li class="breadcrumb-item"> <?php echo $section['nom_section_article']; ?> </li>
						</ul>
					</nav>
				</div>
			</div>
...
<script>
	$(function(){
		...
		var id_section_article = "<?php echo $section['id_section_article']; ?>";

		$("body").find('.'+id_section_article+'_section').addClass('section_link_active');
		...
		$("#id-button-load-more").click(function (e) { 
			...
			$.ajax({
				type: "get",
				url: "<?php echo site_url('AppSection/loadMoreArticles/'); ?>",
				data: {'index_limit_bdd':last_index_date_base,'id_section_article': <?php echo $section['id_section_article'] ?>},
