							...
							<div class="shop-filter mt-xl-2 mt-0">
								<aside>
									...
									<div class="widget widget_search">
										<form action="<?php echo site_url('AppSearch/siteindex/'); ?>" style="width: 100%;" method="post">
											<div class="form-group">
												<div class="input-group">
													<input name="nom_article"  type="search" class="form-control" placeholder="Entrez le nom d'un produit ici ..."  value="<?php if(isset($_POST['nom_article'])) echo $_POST['nom_article'] ?>" >
												</div>
											</div>
											<div class="input-group">
												<input name="prix_min_article"  type="number" class="form-control" placeholder="Prix minimun en $..." value="<?php if(isset($_POST['prix_min_article'])) echo $_POST['prix_min_article'] ?>">
											</div>
											<div class="input-group">
												<input name="prix_max_article"  type="number" class="form-control" placeholder="Prix maximun en $..." value="<?php if(isset($_POST['prix_max_article'])) echo $_POST['prix_max_article'] ?>">
											</div>
											<div class="form-group">
												<div class="input-group">
										...
										<ul>
											<?php 
												if($categories_articles){
													foreach ($categories_articles as $key => $categorie_article_in) {
														echo '<li class="cat-item cat-item-'.$key.'"><a href="'.site_url('AppCategorie/index/'.$categorie_article_in['id_categorie'].'').'" class="'.$categorie_article_in['id_categorie'].'_categorie">'.$categorie_article_in['nom_categorie'].'</a> ('.$categorie_article_in['qte'].')</li>';
													}
												}
											?>
										</ul>
									...
									<div class="widget widget_tag_cloud">
										...
										<div class="tagcloud"> 
											<a href="<?php echo site_url('AppSection/filter/1/'); ?>" class="1_section">MARIAGE </a>
											<a href="<?php echo site_url('AppSection/filter/2/'); ?>" class="2_section">ANNIVERSAIRE</a>
											<a href="<?php echo site_url('AppSection/filter/3/'); ?>" class="3_section">ST VALENTIN</a>
											<a href="<?php echo site_url('AppSection/filter/4/'); ?>" class="4_section">Baby SHOWER</a>
										</div>
									</div>
						...
						<div class="filter-wrapper">
							<div class="filter-left-area">								
								<ul class="filter-tag">
									...
									<li>
										<a href="<?php echo site_url('AppSection/filter/1/'); ?>" class="tag-btn 1_section">MARIAGE
											<i class="icon feather icon-x tag-close"></i>
										</a>
									</li>
									<li>
										<a href="<?php echo site_url('AppSection/filter/2/'); ?>" class="tag-btn 2_section">ANNIVERSAIRE
											<i class="icon feather icon-x tag-close"></i>
										</a>
									</li>
									<li>
										<a href="<?php echo site_url('AppSection/filter/3/'); ?>" class="tag-btn 3_section">ST VALENTIN 
											<i class="icon feather icon-x tag-close"></i>
										</a>
									</li>
									<li>
										<a href="<?php echo site_url('AppSection/filter/4/'); ?>" class="tag-btn 4_section">Baby SHOWER 
											<i class="icon feather icon-x tag-close"></i>
										</a>
									</li>
								</ul>
													...
													echo '  <div class="article_container col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30" idDatabase="'.($key+1).'">
																<div class="shop-card">
																	...
																	<div class="dz-content">
																		...
																		<h6 class="price">
																			<del>'.number_format($twelve_last_article['prix_vente']+10,0,',',' ').'$</del>
																	...
																	<div class="product-tag">
																		...
																		<span class="badge badge-primary" style="background-color: #f31173;">'.$twelve_last_article['nom_categorie'].'</span>
																	</div>
																</div>	
															</div>';
												}
...
<script>
	$(function(){
		...
		$("#id-button-load-more").click(function (e) { 
			...
			let prix_min_article 		= $("input[name='prix_min_article']").val();
			let prix_max_article 		= $("input[name='prix_max_article']").val();
			let nom_article 	 		= $("input[name='nom_article']").val();
			let id_foreign_categorie 	= $("#id_foreign_categorie").val();

			$.ajax({
				type: "get",
				url: "<?php echo site_url('AppSearch/loadMoreArticles/'); ?>",
				data: {
					'index_limit_bdd':last_index_date_base,
					'prix_min_article': prix_min_article,
					'prix_max_article' :prix_max_article,
					'nom_article':nom_article,
					'id_foreign_categorie':id_foreign_categorie
				},
