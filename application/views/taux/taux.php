    ...
    <div class="main_container">
        ...
        <div id="row_content" class="row">
            ...
            <div class="col s12">
                ...
                <form action="<?php echo site_url('Taux_echange/index/');?>" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col s3">
                            <div class="form-group">
                                ...
                                <a href="<?php echo site_url('Taux_echange/index/'); ?>" class="btn btn-success col s12">Effacer le filtre</a>
                            </div>
                        </div>
