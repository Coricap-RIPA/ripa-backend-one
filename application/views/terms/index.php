...
<body>
    ...
    <p>
        ...
        to it, still belong to Fromatter.
    </p>
    <p>
        Fromatter is committed to ensuring that the app is
    ...
    <p>
        The Fromater app stores and processes personal data that
        ...
        that the Fromater app won’t work properly or at all.
    </p>
    <div>
        <p>
    ...
    <p>
        ...
        Fromatter will not take responsibility for. Certain
        functions of the app will require the app to have an active
        internet connection. The connection can be Wi-Fi or provided
        by your mobile network provider, but Fromatter
    ...
    <p>
        Along the same lines, Fromatter cannot always take
        responsibility for the way you use the app i.e. You need to
        make sure that your device stays charged – if it runs out of
        battery and you can’t turn it on to avail the Service,
        Fromatter cannot accept responsibility.
    </p>
    <p>
        With respect to Fromatter’s responsibility for your
        use of the app, when you’re using the app, it’s important to
        bear in mind that although we endeavor to ensure that it is
        updated and correct at all times, we do rely on third parties
        to provide information to us so that we can make it available
        to you. Fromatter accepts no liability for any
    ...
    <p>
        ...
        using the app. Fromatter does not promise that it
