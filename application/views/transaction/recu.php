...
<body style="background-color: whitesmoke;">
    ...
    <div class="main_container">
        ...
        <div id="row_content" class="row">
            ...
            <div class="col  s12">
                <form action="<?php echo site_url('Transaction/recu/');?>" method="POST">
                            ...
                            <div class="col s3">
                                <div class="form-group">
                                    ...
                                    <select name="id_foreign_statut_execution" id="id_foreign_statut_execution" class="form-control browser-default input-sm chosen-select" style="display: none;">
                                        <option value="null"> Séléctionnez un status d'éxécution </option>
                                        <?php
                            ...
                            <div class="col s3">
                                <div class="form-group">
                                    ...
                                    <select name="id_foreign_statut_transaction" id="id_foreign_statut_transaction" class="form-control browser-default input-sm chosen-select" style="display: none;">
                                        <option value="null"> Séléctionnez un status de la transaction </option>
                                        <?php
                        ...
                        <div class="row col s12">
                            ...
                            <div class="col s4">
                                <div class="form-group">
                                    ...
                                    <a href="<?php echo site_url('Transaction/recu/'); ?>" class="btn btn-success col s12">Effacer le filtre</a>
                                </div>
                            </div>
