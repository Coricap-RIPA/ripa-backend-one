...
--
-- Hôte : localhost
-- Généré le : jeu. 05 mars 2026 à 01:55
...
--
-- Structure de la table `carte_utilisateur_application`
--

CREATE TABLE `carte_utilisateur_application` (
  ...
  `date_expiration` char(7) DEFAULT NULL COMMENT 'MM/YYYY si nécessaire métier',
  `type_carte` enum('virtuelle','physique') NOT NULL DEFAULT 'virtuelle',
  `brand` varchar(20) DEFAULT NULL COMMENT 'Visa, Mastercard (détection BIN ou Vault)',
  `is_active` tinyint(1) NOT NULL DEFAULT 1,
  `date_creation` datetime NOT NULL DEFAULT current_timestamp(),
  `date_maj` datetime DEFAULT NULL ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Cartes utilisateur - PCI DSS - token + last4 uniquement, pas de PAN/CVV';
...
--
-- Structure de la table `compte_mobile_money_utilisateur_application`
--

CREATE TABLE `compte_mobile_money_utilisateur_application` (
  ...
  `date_creation` datetime NOT NULL DEFAULT current_timestamp(),
  `date_maj` datetime DEFAULT NULL ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Comptes mobile money app - numéro chiffré - table dédiée';
...
--
-- Structure de la table `kyc_utilisateur_application`
--

CREATE TABLE `kyc_utilisateur_application` (
  `id_kyc` int(11) NOT NULL,
  `id_utilisateur_application` int(11) NOT NULL,
  `nom_c` text DEFAULT NULL COMMENT 'Nom chiffré (encrypt_ripa)',
  `post_nom_c` text DEFAULT NULL COMMENT 'Post-nom chiffré',
  `prenom_c` text DEFAULT NULL COMMENT 'Prénom chiffré',
  `date_naissance_c` text DEFAULT NULL COMMENT 'Date de naissance chiffrée (YYYY-MM-DD)',
  `adresse_c` text DEFAULT NULL COMMENT 'Adresse chiffrée',
  `photo_piece_identite_c` mediumtext DEFAULT NULL COMMENT 'Photo pièce d''identité chiffrée (encrypt_ripa)',
  `photo_utilisateur_c` mediumtext DEFAULT NULL COMMENT 'Photo utilisateur / selfie chiffrée (encrypt_ripa)',
  `date_enregistrement` datetime NOT NULL DEFAULT current_timestamp() COMMENT 'Date de soumission du KYC par l''utilisateur',
  `date_validation_kyc` date DEFAULT NULL COMMENT 'Date de validation par les admins RIPA',
  `date_prochaine_kyc` date DEFAULT NULL COMMENT 'Date de la prochaine révision KYC (2 ans après date_validation_kyc)',
  `statut` enum('en_attente','valide','rejete') NOT NULL DEFAULT 'en_attente',
  `date_maj` datetime DEFAULT NULL ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='KYC utilisateur - données chiffrées - validation RIPA';

-- --------------------------------------------------------

--
-- Structure de la table `log_utilisateur_application`
--

CREATE TABLE `log_utilisateur_application` (
  `id_log` int(11) NOT NULL,
  `id_utilisateur_application` int(11) DEFAULT NULL COMMENT 'NULL si action avant login (ex. inscription)',
  `action` varchar(100) NOT NULL COMMENT 'ex: inscription, connexion, ajout_compte_money, enregistrement_carte',
  `ressource` varchar(80) DEFAULT NULL COMMENT 'ex: utilisateur_application, compte_financier_utilisateur_application',
  `id_ressource` int(11) DEFAULT NULL,
  `details` text DEFAULT NULL COMMENT 'JSON ou texte sanitized (jamais PAN/CVV/token/mot de passe)',
  `ip_address` varchar(45) DEFAULT NULL,
  `user_agent` varchar(255) DEFAULT NULL,
  `created_at` datetime NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Logs des actions app - PCI DSS - aucune donnée carte sensible';
...
(16, 1, '7594', '2026-03-01 23:36:17', 1, '2026-03-01 23:26:17');
...
CREATE TABLE `utilisateur_application` (
  ...
  `post_nom_c` text DEFAULT NULL COMMENT 'Post-nom chiffré',
  `prenom_c` text DEFAULT NULL COMMENT 'Prénom chiffré',
  `tel_c` text DEFAULT NULL COMMENT 'Téléphone chiffré (affichage)',
  `phone_hash` varchar(64) DEFAULT NULL COMMENT 'SHA256(phone) pour login et unicité',
  `email_c` text DEFAULT NULL COMMENT 'Email chiffré',
...
INSERT INTO `utilisateur_application` (`id_utilisateur_application`, `phone`, `nom_c`, `post_nom_c`, `prenom_c`, `tel_c`, `phone_hash`, `email_c`, `mot_passe_pin`, `date_enregistrement`) VALUES
(1, '+243971403075', 'HulMnEh28mjv2ynsesSvOUM8ZeHTJM/uDtwpIXJq73Q=', '0NEUASHS1ThrwQ+bZBWCWabR9CJTKZsyufw4jRXN8ng=', '3fvyYUrOSGHexeuovUf8lXxmuomfKLb392XhpoMvlS4=', 'UcwQtxdyzc7/LOL1B6d5OHM5ohlEcd4N9cxE+e+fRks=', '7094a0adf09027d84c940a4349ca686e02420f5c95f2a89f9bb00d3592cbe553', NULL, '$2y$10$.aJN9YRTAitlqz2rD90ZleAXjpOoPxA0Iivj5jrzquqZXWwQV2yVC', '2026-03-01');
...
--
-- Index pour la table `carte_utilisateur_application`
--
ALTER TABLE `carte_utilisateur_application`
  ADD PRIMARY KEY (`id_carte`),
  ADD KEY `idx_utilisateur` (`id_utilisateur_application`),
  ADD KEY `idx_token_vault` (`token_vault`);
...
--
-- Index pour la table `compte_mobile_money_utilisateur_application`
--
ALTER TABLE `compte_mobile_money_utilisateur_application`
  ADD PRIMARY KEY (`id_compte_mobile_money`),
  ADD KEY `idx_utilisateur` (`id_utilisateur_application`),
  ADD KEY `idx_type` (`id_type_mobile_money`);
...
--
-- Index pour la table `kyc_utilisateur_application`
--
ALTER TABLE `kyc_utilisateur_application`
  ADD PRIMARY KEY (`id_kyc`),
  ADD UNIQUE KEY `uk_utilisateur` (`id_utilisateur_application`),
  ADD KEY `idx_statut` (`statut`),
  ADD KEY `idx_date_validation` (`date_validation_kyc`);

--
-- Index pour la table `log_utilisateur_application`
--
ALTER TABLE `log_utilisateur_application`
...
--
-- AUTO_INCREMENT pour la table `carte_utilisateur_application`
--
ALTER TABLE `carte_utilisateur_application`
...
--
-- AUTO_INCREMENT pour la table `compte_mobile_money_utilisateur_application`
--
ALTER TABLE `compte_mobile_money_utilisateur_application`
  MODIFY `id_compte_mobile_money` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT pour la table `kyc_utilisateur_application`
--
ALTER TABLE `kyc_utilisateur_application`
  MODIFY `id_kyc` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `log_utilisateur_application`
--
ALTER TABLE `log_utilisateur_application`
...
--
ALTER TABLE `utilisateur_application`
  MODIFY `id_utilisateur_application` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- Contraintes pour la table `carte_utilisateur_application`
--
ALTER TABLE `carte_utilisateur_application`
  ADD CONSTRAINT `fk_carte_utilisateur` FOREIGN KEY (`id_utilisateur_application`) REFERENCES `utilisateur_application` (`id_utilisateur_application`) ON DELETE CASCADE;

--
-- Contraintes pour la table `compte_mobile_money_utilisateur_application`
--
ALTER TABLE `compte_mobile_money_utilisateur_application`
  ADD CONSTRAINT `fk_compte_mm_type` FOREIGN KEY (`id_type_mobile_money`) REFERENCES `type_mobile_money` (`id_type_mobile_money`),
  ADD CONSTRAINT `fk_compte_mm_utilisateur` FOREIGN KEY (`id_utilisateur_application`) REFERENCES `utilisateur_application` (`id_utilisateur_application`) ON DELETE CASCADE;
...
--
-- Contraintes pour la table `kyc_utilisateur_application`
--
ALTER TABLE `kyc_utilisateur_application`
  ADD CONSTRAINT `fk_kyc_utilisateur` FOREIGN KEY (`id_utilisateur_application`) REFERENCES `utilisateur_application` (`id_utilisateur_application`) ON DELETE CASCADE;
